...
export default function ModelNotifications({ loaderData }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 sm:bg-white">
      <div className="max-w-4xl mx-auto sticky top-0 z-10 bg-white border-b px-4 sm:px-8 py-4 sm:py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-md sm:text-lg text-gray-900">
      ...
      <div className="max-w-4xl mx-auto">
        {notifications.length > 0 ? (
          <div className="bg-white sm:bg-transparent pr-4 sm:pr-0">
