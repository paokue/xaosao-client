    ...
    if (request.method === "POST") {
        if (addFriend === true) {
            try {
                ...
                if (res?.success) {
                    return redirect(`/dashboard/matches?toastMessage=Add+friend+successfully!&toastType=success`);
                }
            } catch (error: any) {
                return redirect(`/dashboard/matches?toastMessage=${error.message}&toastType=error`);
            }
        } else {
            ...
            try {
                ...
                return redirect(
                    `/dashboard/matches?toastMessage=${encodeURIComponent(
