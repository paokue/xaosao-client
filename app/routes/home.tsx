  ...
  return (
    <div className="fullscreen safe-area min-h-screen bg-background text-foreground transition-colors duration-300 font-serif">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 px-2 max-w-5xl mx-auto text-center lg:px-8 leading-3 space-y-4">
          <DynamicSlogan />

          <p className="text-white max-w-2xl mx-auto leading-relaxed px-4 text-md sm:text-lg">
          ...
          <div className="flex gap-4 justify-center items-center max-w-md mx-auto">
            <Button
              size="lg"
              className="cursor-pointer w-auto bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-medium shadow-xl hover:shadow-pink-500/25 transition-all duration-300 transform hover:scale-105 border-0 rounded-lg"
              onClick={() => navigate("/register")}
            >
              Get Started
              <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5 animate-bounce" />
            </Button>
            <Button
              size="lg"
